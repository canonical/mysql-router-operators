...
@pytest.mark.abort_on_fail
async def test_scale_to_zero(ops_test: OpsTest) -> None:
    """Test scaling down to zero when the relation is yet active."""
    await scale_application(ops_test, MYSQL_ROUTER_APP_NAME, 0)
    await scale_application(ops_test, TEST_APP_NAME, 0)

    logger.info("Waiting for applications to become active")
    await ops_test.model.wait_for_idle(
        [MYSQL_ROUTER_APP_NAME, TEST_APP_NAME],
        status="active",
