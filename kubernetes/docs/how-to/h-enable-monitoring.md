...
mysql-k8s                    8.0.35   active      1  mysql-k8s                    8.0/stable  127  10.152.183.105  no
mysql-router-k8s             8.0.35   active      1  mysql-router-k8s             8.0/stable  102  10.152.183.92   no
mysql-test-app               0.0.2    active      1  mysql-test-app               stable       36  10.152.183.35   no
opentelemetry-collector-k8s           active      1  opentelemetry-collector-k8s  2/stable    207  10.152.183.141  no
